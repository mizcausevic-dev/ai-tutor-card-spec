...
What comes next is practical. The roadmap is about pushing the project deeper into real operational utility: closed-loop intervention reporting, better pathway simulation, and stronger AI-governance joins for education workflows. That direction matters because the long-term value of **ai-tutor-card-spec** is not the individual screen or endpoint. It is the operating discipline behind it. That is the operating discipline this repo is trying to make concrete.
