...
### Released
- Published **ai-tutor-card-spec** as a public, portfolio-grade education operations system.
...
- That insight became the basis for **ai-tutor-card-spec**.
